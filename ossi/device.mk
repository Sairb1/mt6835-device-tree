...
# Exclude incompatible AOSP example modules
PRODUCT_PACKAGES := $(filter-out ExampleVibratorJavaProductClient,$(PRODUCT_PACKAGES))
PRODUCT_PACKAGES := $(filter-out ExampleVibratorJavaProductClient,$(PRODUCT_PACKAGES))

# Exclude large unused AOSP modules to reduce soong analysis memory
...
PRODUCT_COPY_FILES += \
    system/core/rootdir/etc/task_profiles.json:$(TARGET_COPY_OUT_SYSTEM)/etc/task_profiles.json