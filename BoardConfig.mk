...
##########################################
# --- CRITICAL FBEV2 / KEYMINT FIXES ---
##########################################

# 1. Disable keystore2 crashes + disable dm-verity
BOARD_FORCE_DISABLE_DM_VERITY := true
BOARD_AVB_ENABLE := true

# 2. Enable Keymint & new FBE 
TW_INCLUDE_KEYMINT := true  
TW_INCLUDE_FSCRYPT := true
TW_USE_NEW_FBE_DECRYPTION := true 
 

# 4. Optional oplus init handler
# TARGET_RECOVERY_DEVICE_MODULES += libinit_ops 
